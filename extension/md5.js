// Minimal MD5 (RFC 1321) — needed to build the MuseScore jmuse Authorization
// header. Bundled locally because the extension may not load remote scripts.
(function (global) {
  ...
  // UTF-8 encode, then hash — MuseScore ids and suffixes are ASCII anyway
  function md5(str) {
